...
4.1.1.1. Extended HELLO (EHLO) or HELLO (HELO)
   ...
   Private-use commands MAY be listed.
    ...
    /// <summary>
    /// The HELOCommand class represents a SMTP HELLO command.
    /// </summary>
    public class HELOCommand : SmtpCommand
    {
        ...
        {
            get { return SmtpCommandType.HELO; }
        }

        /// <summary>
        /// Gets / sets the host name of the SMTP client used to identify itself.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the HELOCommand class.
        /// </summary>
        public HELOCommand()
        {
        ...
        /// <summary>
        /// Initializes a new instance of the HELOCommand class identifying the client using the specified
        /// host name.
        /// </summary>
        /// <param name="hostName"></param>
        public HELOCommand(string hostName)
            : this()
        {
